...
var vm = new listenerVue({
    ...
    methods: {
        ...
        obtainLicenseFromGoogle: function obtainLicenseFromGoogle(token) {
            var self = this;
            var requestData = {
                client_id: CLIENT_ID,
                access_token: token
            ...
            this.$http.get("https://www.googleapis.com/chromewebstore/v1.1/userlicenses/" + chrome.runtime.id, requestData, function (license, status, request) {
        ...
        isValidLicense: function isValidLicense(license) {
    ...
    events: {
        'grab-complete': function grabComplete(site) {
            ...
            if (Object.keys(this.sites).length > 0) {
                ...
                var self = this;
                this.sites = Object.keys(self.sites).map(function (k) {
                    return self.sites[k];
                });
            }
            console.log(this.sites);
        ...
        'license-received': function licenseReceived(license) {
            this.validLicense = this.isValidLicense(license);
            this.$emit('send', 'license-checked', this.validLicense);
        },
        'user-token': function userToken(token) {
            this.token = token;
...
},{"./vue/components/listening-post.vue":6,"vue":4,"vue-resource":3}],6:[function(require,module,exports){
'use strict';
