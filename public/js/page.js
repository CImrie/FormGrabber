...
new listenerVue({
    ...
    events: {
        ...
        'grabbed-one': function grabbedOne(data) {
...
var __vueify_style__ = require("vueify-insert-css").insert("\n    #fg-alerts-container[_v-4eb53a18] {\n        z-index:9999999;\n        position:fixed;\n        height: 100%;\n        min-width:300px;\n        width:22%;\n        right:0;\n        bottom:0;\n        top:0;\n        /*background-color:grey;*/\n        pointer-events: none;\n        display: -webkit-box;\n        display: -ms-flexbox;\n        display: flex;\n        -webkit-box-orient: vertical;\n        -webkit-box-direction: reverse;\n            -ms-flex-direction: column-reverse;\n                flex-direction: column-reverse;\n    }\n")
"use strict";

var alert = require('./corner-alert.vue');
module.exports = {
    props: {
        alerts: {
            type: Array,
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div id=\"fg-alerts-container\" _v-4eb53a18=\"\">\n        <fg-alert v-for=\"alert in alerts\" :button=\"alert.button\" :type=\"alert.type\" :message=\"alert.body\" :heading=\"alert.heading\" _v-4eb53a18=\"\"></fg-alert>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/connorimrie/Dropbox/Random State Ltd/FormGrabberExtension/resources/assets/js/vue/components/alerts-container.vue"
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div v-bind:class=\"['fg-alert', alertClass ? alertClass : '']\" v-if=\"show\" transition=\"bounce\" _v-5df0e331=\"\">\n        <div class=\"fg-alert-heading\" _v-5df0e331=\"\">{{ heading }}</div>\n        <div _v-5df0e331=\"\">{{{ message }}}</div>\n        <div class=\"fg-alert-button\" v-if=\"button != undefined\" _v-5df0e331=\"\"><button v-on:click=\"button.onClick\" _v-5df0e331=\"\">{{button.text}}</button></div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/connorimrie/Dropbox/Random State Ltd/FormGrabberExtension/resources/assets/js/vue/components/corner-alert.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    .fg-pull-right[_v-5df0e331] {\n        float:right;\n    }\n\n    .fg-icon[_v-5df0e331] {\n        color:grey;\n        font-size: 0.85em;\n        pointer-events: auto;\n        cursor:pointer;\n    }\n\n    .fg-alert-heading[_v-5df0e331]{\n        font-size: 1.1em;\n        font-weight: bold;\n        padding-bottom:10px;\n    }\n\n    .fg-alert-button[_v-5df0e331] {\n        padding-top:10px;\n    }\n\n    .fg-alert-button button[_v-5df0e331]{\n        padding:10px;\n        font-weight:bold;\n\n        border: 1px solid rgb(248, 101, 116);\n        background-color: rgb(255, 134, 147);\n        border-radius:3px;\n        box-shadow: 0;\n\n        pointer-events:auto;\n        cursor:pointer;\n    }\n\n    .fg-alert-button button[_v-5df0e331]:focus {\n        outline:0;\n    }\n\n    .fg-alert[_v-5df0e331] {\n        font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n        color:black;\n        margin:15px;\n        margin-top: 0px;\n        padding:20px;\n    }\n\n    .fg-alert-success[_v-5df0e331] {\n        border-bottom: 8px solid #B9EB6C;\n        background-color: #d0f29c;\n        border-radius: 5px;\n    }\n\n    .fg-alert-warning[_v-5df0e331] {\n        border-bottom: 8px solid #FFB488;\n        background-color: #ffd5bd;\n        border-radius: 5px;\n    }\n\n    .fg-alert-error[_v-5df0e331] {\n        border-bottom: 8px solid #FF8693;\n        background-color: #ffbdc4;\n        border-radius: 5px;\n    }\n\n    .bounce-enter[_v-5df0e331] {\n        -webkit-animation: bounce-in .3s;\n                animation: bounce-in .3s;\n    }\n    .bounce-leave[_v-5df0e331] {\n        -webkit-animation: bounce-out .3s;\n                animation: bounce-out .3s;\n    }\n    @-webkit-keyframes bounce-in {\n        0% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n    }\n    @keyframes bounce-in {\n        0% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n    }\n    @-webkit-keyframes bounce-out {\n        0% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n    }\n    @keyframes bounce-out {\n        0% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n    }\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/connorimrie/Dropbox/Random State Ltd/FormGrabberExtension/resources/assets/js/vue/components/float.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    .fg-float-heading {\n        font-weight:bold;\n        font-size: 1.2em;\n    }\n    .fg-float {\n        position:absolute;\n        left:0px;\n        top:0px;\n        z-index:999999;\n        border-bottom: 8px solid #8CDDFF;\n\n        background-color: #c2edff;\n        padding:12px;\n        border-radius: 5px;\n        box-shadow: 0;\n    }\n\n    .bounce-enter {\n        -webkit-animation: bounce-in .3s;\n                animation: bounce-in .3s;\n    }\n    .bounce-leave {\n        -webkit-animation: bounce-out .3s;\n                animation: bounce-out .3s;\n    }\n    @-webkit-keyframes bounce-in {\n        0% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n    }\n    @keyframes bounce-in {\n        0% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n    }\n    @-webkit-keyframes bounce-out {\n        0% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n    }\n    @keyframes bounce-out {\n        0% {\n            -webkit-transform: scale(1);\n                    transform: scale(1);\n        }\n        50% {\n            -webkit-transform: scale(1.25);\n                    transform: scale(1.25);\n        }\n        100% {\n            -webkit-transform: scale(0);\n                    transform: scale(0);\n        }\n    }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
