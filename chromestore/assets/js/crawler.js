...
{
    var success = new Message('body', 'success-message-formgrabber','alert alert-success col-md-6 col-md-offset-3', '<strong>POW!</strong> (stored)')
        .show()
        .timeout(2000);
};
var cancelledMessage = function()
{
    var cancelled = new Message('body', 'cancelled-message-formgrabber','alert alert-danger col-md-6 col-md-offset-3', '<strong>Major non-pow!-al</strong> (cancelled)')
        .show()
        .timeout(2000);
};
var lastRemovedMessage = function(message)
{
    var removed = new Message('body', 'mistake-message-formgrabber','alert alert-info col-md-6 col-md-offset-3', '<strong>Un-pow!</strong> (last removed' + (message ? '"' + message + '"' : "") + ')')
        .show()
        .timeout(2000);
}
